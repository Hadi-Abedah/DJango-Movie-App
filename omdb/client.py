...
class OmdbMovie:
    ...
    def check_for_detail(self, key):
        if key not in self.data: #self.data is a dict
...
class OmdbClient:
    ...
    def make_request(self, params):
        """make a GET request to the API, automatically adding the API Key"""
